...
if (CUDA_VERSION VERSION_GREATER_EQUAL "12.8")
  # Blackwell generic SM targets first supported by CUDA 12.8:
  #   100: B200/GB200
  #   101: early Blackwell target supported by CUDA 12.8/12.9
  #   120: RTX/consumer/RTX PRO Blackwell
  list(APPEND dgl_known_gpu_archs "100" "101" "120")
  set(dgl_cuda_arch_ptx "120")
endif()
if (CUDA_VERSION VERSION_GREATER_EQUAL "12.9")
  # Blackwell generic SM targets first supported by CUDA 12.9:
  #   103: B300/GB300
  #   121: GB10 / DGX Spark
  list(APPEND dgl_known_gpu_archs "103" "121")
  set(dgl_cuda_arch_ptx "121")
endif()
if (CUDA_VERSION VERSION_GREATER_EQUAL "13.0")
  # CUDA 13 removes offline compilation/library support for pre-Turing
  # Maxwell/Pascal/Volta, and adds Blackwell Jetson.
  list(REMOVE_ITEM dgl_known_gpu_archs "50" "60" "70" "101")
  list(APPEND dgl_known_gpu_archs "110")
  set(dgl_cuda_arch_ptx "121")
endif()
...
function(dgl_select_nvcc_arch_flags out_variable)
  ...
  if (CUDA_VERSION VERSION_GREATER_EQUAL "12.8")
    list(APPEND __archs_names "BlackwellB200" "BlackwellRTX")
  endif()
  if (CUDA_VERSION VERSION_GREATER_EQUAL "12.8" AND CUDA_VERSION VERSION_LESS "13.0")
    list(APPEND __archs_names "BlackwellSM101")
  endif()
  if (CUDA_VERSION VERSION_GREATER_EQUAL "12.9")
    list(APPEND __archs_names "BlackwellB300" "BlackwellDGXSpark")
  endif()
  if (CUDA_VERSION VERSION_GREATER_EQUAL "13.0")
    list(REMOVE_ITEM __archs_names "Maxwell" "Pascal" "Volta" "BlackwellSM101")
    list(APPEND __archs_names "BlackwellJetson")
  endif()
  if (CUDA_VERSION VERSION_GREATER_EQUAL "12.8")
    list(APPEND __archs_names "Blackwell")
  endif()
  ...
  elseif(${CUDA_ARCH_NAME} STREQUAL "BlackwellB200")
    set(__cuda_arch_bin "100")
    set(__cuda_arch_ptx "100")
  elseif(${CUDA_ARCH_NAME} STREQUAL "BlackwellSM101")
    set(__cuda_arch_bin "101")
    set(__cuda_arch_ptx "101")
  elseif(${CUDA_ARCH_NAME} STREQUAL "BlackwellB300")
    set(__cuda_arch_bin "103")
    set(__cuda_arch_ptx "103")
  elseif(${CUDA_ARCH_NAME} STREQUAL "BlackwellJetson")
    set(__cuda_arch_bin "110")
    set(__cuda_arch_ptx "110")
  elseif(${CUDA_ARCH_NAME} STREQUAL "BlackwellRTX")
    set(__cuda_arch_bin "120")
    set(__cuda_arch_ptx "120")
  elseif(${CUDA_ARCH_NAME} STREQUAL "BlackwellDGXSpark")
    set(__cuda_arch_bin "121")
    set(__cuda_arch_ptx "121")
  elseif(${CUDA_ARCH_NAME} STREQUAL "Blackwell")
    if (CUDA_VERSION VERSION_GREATER_EQUAL "13.0")
      set(__cuda_arch_bin "100" "103" "110" "120" "121")
      set(__cuda_arch_ptx "121")
    elseif (CUDA_VERSION VERSION_GREATER_EQUAL "12.9")
      set(__cuda_arch_bin "100" "101" "103" "120" "121")
      set(__cuda_arch_ptx "121")
    else()
      set(__cuda_arch_bin "100" "101" "120")
      set(__cuda_arch_ptx "120")
    endif()
